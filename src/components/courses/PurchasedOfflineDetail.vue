<template>
  <div v-if="localDialog" class="dialog">
    <v-container fluid dark>
      <v-row>
        <v-col cols="12"
          ><v-btn @click="localDialog = false" color="orange">
        ...
        >
          <v-card flat class="mb-8 transparent" dark>
            ...
            <v-card-text class="pa-0 pl-4 buttons--text d-flex">offline course</v-card-text>
          ...
          <v-card flat class="transparent d-flex flex-column align-center" dark>
            <table>
              ...
              <tr v-for="item in dateOfCourses" :key="item.id">
                ...
                <td class="text-right">
                  <v-chip :color="item.paid ? 'paidAndPublished' : 'notPaidAndPublished'" text-color="white">
                    {{ item.paid ? 'paid' : 'not paid' }}</v-chip
                  >
                </td>
              </tr>
            </table>
