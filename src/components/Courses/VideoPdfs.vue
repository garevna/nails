<template>
  <div>
    <div class="d-flex">
      <div>
        <div v-if="pdfs[0] && pdfFileShow1" class="pdf-container pt-12">
      ...
      <div>
        <div v-if="pdfs[1] && pdfFileShow2" class="pdf-container pt-12 mx-16">
      ...
      <div>
        <div v-if="pdfs[2] && pdfFileShow3" class="pdf-container pt-12">
